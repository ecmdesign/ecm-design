 ...
 */
function _s_post_nav( $prev_text = '%title', $next_text = '%title' ) {
	...
	<nav class="navigation post-navigation" role="navigation">
		...
		<div class="nav-links">
			<?php
				previous_post_link( '<div class="nav-previous">%link</div>', _x( '<span class="meta-nav">&larr;</span>&nbsp;' . $prev_text . '', 'Previous post link', '_s' ) );
				next_post_link(     '<div class="nav-next">%link</div>',     _x( '' . $next_text . '&nbsp;<span class="meta-nav">&rarr;</span>', 'Next post link',     '_s' ) );
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
	<?php
